...
export default function ImageCard({ src, alt, className }: ImageCardProps) {
  return (
    <div
      className={`${className} sm:rounded-4xl relative flex w-full items-center justify-center overflow-hidden`}
    >
      {src ? (
        <Image
          src={src}
        ...
        <div className="flex h-full w-full flex-col items-center justify-center rounded-lg bg-zinc-400/10">
          <svg
            className="h-8 w-8"
            viewBox="0 0 24 24"
            fill="none"
